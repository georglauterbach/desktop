...
| Wayland Compositor | [SwayFX](https://github.com/WillPower3309/swayfx) | <ul><li>Sway is minimal, solid & fast</li><li>SwayFX = Sway + "eye candy"</li></ul> | This package is [custom-built](./custom/wayland/).<br/> You can disable the SwayFX-specific config easily when using plain Sway. |
| Status Bar | [Waybar](https://github.com/Alexays/Waybar) | <ul><li>minimal</li><li>easily yet highly customizable</li></ul> | This package is [custom-built](./custom/wayland/). |
| Notification Daemon | [SwayNotificationCenter](https://github.com/ErikReider/SwayNotificationCenter) | <ul><li>simple & solid</li></ul> | This package is [custom-built](./custom/wayland/). |
| Application Launcher | [Rofi](https://github.com/davatorium/rofi) | <ul><li>minimal</li><li>easily yet highly customizable</li></ul> | This package is [custom-built](./custom/wayland/). |
| Terminal | [Alacritty](https://github.com/alacritty/alacritty) | <ul><li>extremely fast & robust</li></ul> | As an alternative, `kitty` is installed for visualizing files inside the terminal. |
