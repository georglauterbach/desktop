...
done < <(command find "${OUT_DIR}/"{bin,etc,lib/udev,libexec,man,share/{applications,bash-completion,dbus-1,glib-2.0,icons,libinput,man,metainfo,nwg-look,rofi,wayland*}} -type f)
